...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Des 2022 pada 02.59
...
(13851, 74, '20221128001', 'raga', '', '2022-11-28', '20000', 'masuk'),
(13851, 74, '20221216001', 'Keperluan dana KPU', '', '2022-12-16', '150000', 'masuk'),
(13854, 74, '20221216002', 'tes', '', '2022-12-16', '152000', 'masuk'),
(13854, 74, '20221216003', 'res', '', '2022-12-16', '50000', 'masuk'),
(13851, 81, '20221216004', 'raga', '20221216004.jpg', '2022-12-16', '50000', 'keluar'),
(13851, 74, '20221216005', 'rtgfdrtg', '', '2022-12-16', '161113', 'masuk'),
(13851, 74, '20221216006', 'tgfh', '', '2022-12-16', '52000', 'masuk'),
(13854, 79, '20221219001', 'raga', '20221219001.jpg', '2022-12-19', '30000', 'keluar');
...
(295, 'CD_DOC', 'DOC02', 'SURAT KONTRAK', 'Y', NULL);
...
CREATE TABLE `m_penduduk` (
  ...
  `REASON_DIED` text COLLATE utf8mb4_unicode_ci,
  `DATE_MUTATION` date DEFAULT NULL,
  `REASON_MUTATION` text COLLATE utf8mb4_unicode_ci,
...
(994, 'superadmin', 'PRT0003', 'PRT0003', 'PRT000302', 'Program Kerja', 'Y', 'admin/proker', 'far fa-circle'),
...
(1186, 'GM', 'PRT0002', 'P', 'PRT0002', 'Web', 'N', '#', 'fas fa-globe-americas'),
...
(1325, 'superadmin', 'PRT000305', 'PRT0001', 'PRT000305', 'Data Barang', 'Y', 'admin/Barang', 'far fa-circle'),
(1327, 'superadmin', 'PRT000306', 'PRT0001', 'PRT000306', 'Periode', 'Y', 'admin/periode', 'far fa-circle'),
(1328, 'superadmin', 'PRT000307', 'PRT0001', 'PRT000307', 'Kode Barang', 'Y', 'admin/Kode', 'far fa-circle');
...
CREATE TABLE `tbbarang` (
  ...
  `grid_pro` int(11) NOT NULL,
  `width_pro` int(11) NOT NULL,
  `length_pro` int(11) NOT NULL,
  `qty_pro` int(11) NOT NULL,
  `desc_pro` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbbarang` (`id_pro`, `id_status`, `id_brg`, `grid_pro`, `width_pro`, `length_pro`, `qty_pro`, `desc_pro`) VALUES
(1, 1, 1, 320, 1370, 120, 2, 'raga'),
(2, 1, 2, 240, 1370, 120, 2, 'rg'),
(3, 1, 2, 600, 1400, 200, 5, 'g'),
(4, 1, 1, 240, 1370, 120, 10, '-'),
(5, 1, 3, 320, 1370, 20, 3, ''),
(6, 1, 116, 180, 1370, 200, 1, '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbbrg`
--

CREATE TABLE `tbbrg` (
  `id_brg` int(11) NOT NULL,
  `name_brg` varchar(250) NOT NULL,
  `kode_brg` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tbbrg`
--

INSERT INTO `tbbrg` (`id_brg`, `name_brg`, `kode_brg`) VALUES
(1, 'EKA1000 F', 100),
(2, 'EKA1000 E', 101),
(3, 'EKA3001 N', 102),
(4, 'APKFO', 103),
...
(98, 'TX 100 A', 721),
(99, 'GBSMM', 724),
(100, 'DERI / AP 43 M', 726),
(101, 'TP 88', 727),
(102, 'TC 136 Y', 732),
(103, 'A 38 X', 733),
(104, 'F1.CARPENTER', 734),
(105, 'T. KLASIK', 735),
(106, 'F1 SMART', 736),
(107, 'D 332', 737),
(108, 'AP 33 M', 738),
...
(117, 'TAIYOSMART', 751),
(118, 'BIMA', 752),
(119, 'NO BRAND 200 gr', 754),
(120, 'EKALITE AF-9', 755),
(121, 'Y 871M', 756),
(122, 'LY 872', 757),
(123, 'HF 100', 759),
(124, 'AE 100', 760),
...
--
-- Struktur dari tabel `tbstatus`
--

CREATE TABLE `tbstatus` (
  `id_status` int(11) NOT NULL,
  `name_status` varchar(250) NOT NULL,
  `desc_status` enum('P','T') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tbstatus`
--

INSERT INTO `tbstatus` (`id_status`, `name_status`, `desc_status`) VALUES
(1, 'Tidak', 'T'),
(2, 'Print', 'P');
...
(8, 1, '', 'DOC01', 'A', 'keterangan ahliwaris', '2022-02-20', 'superadmin', 'Y', '2022-11-30', 'superadmin'),
(9, 103, '', 'DOC01', 'A', 'Surat Pengantar KUA', '2022-02-20', 'superadmin', 'Y', '2022-02-20', 'superadmin'),
(12, 2, '', 'DOC01', 'A', 'KEPERLUAN', '2022-11-30', 'sapta', 'Y', NULL, NULL),
(14, 3, '', 'DOC02', 'A', 'TAWETERTERT', '2022-11-30', 'superadmin', 'Y', '2022-11-30', 'superadmin'),
(16, 100, '', 'DOC02', 'O', 'raga', '2022-12-16', 'superadmin', 'N', NULL, NULL);
...
--
-- Indeks untuk tabel `tbbrg`
--
ALTER TABLE `tbbrg`
  ADD PRIMARY KEY (`id_brg`);

--
-- Indeks untuk tabel `tbstatus`
--
...
--
ALTER TABLE `m_gcm`
  MODIFY `NO_SR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=296;
...
--
ALTER TABLE `m_treeacc`
  MODIFY `ID_TREE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1329;

--
-- AUTO_INCREMENT untuk tabel `periode`
--
ALTER TABLE `periode`
  MODIFY `id_periode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13855;
...
--
-- AUTO_INCREMENT untuk tabel `tbbrg`
--
ALTER TABLE `tbbrg`
  MODIFY `id_brg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;

--
-- AUTO_INCREMENT untuk tabel `tbstatus`
--
ALTER TABLE `tbstatus`
...
--
ALTER TABLE `t_request_file`
  MODIFY `REQUEST_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
