...
class Model_meninggal extends CI_Model
{
    ...
    public function listing()
    {
        ...
        (SELECT m_gcm.DESCRIPTION
         ...
         WHERE  m_gcm.PARAMETER = 'CD_MARRIED' AND m_gcm.CODE = STATUS)
          AS STATUS,DATE_DIED,REASON_DIED");
        $this->db->from($this->table);
        $this->db->where('DATE_DIED IS NOT NULL');
        $this->db->or_where('DATE_DIED', '0000-00-00');
    ...
    public function listing_bulan($date1, $date2)
    {
        ...
        $this->db->where('DATE_DIED >=', $date1);
        $this->db->where('DATE_DIED <=', $date2);
