...
class Pendatang extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('penduduk/Model_pendatang', 'mpenduduk');
        $this->simple_login->terotentikasi();
        // if ($this->session->userdata('akses_level') != 'superadmin')
        //     show_404();
        $this->load->model('konfigurasi_model');
        $result = $this->konfigurasi_model->cekMenu($this->session->userdata('akses_level'), 'penduduk/pendatang');
    ...
    public function tambah()
    {
        ...
        if ($valid->run()) {
            ...
            $this->session->set_flashdata('sukses', 'Pendatang berhasil ditambah');
