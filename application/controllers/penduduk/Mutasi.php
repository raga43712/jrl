...
class Mutasi extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('penduduk/Model_mutasi', 'mpenduduk');
    ...
    public function tambah()
    {
        ...
        if ($valid->run()) {
            ...
            $data = array(
                ...
                'REASON_MUTATION'    =>  $i->post('reason'),
                'DATE_MUTATION' => $i->post('datedied')
            ...
            redirect(site_url('penduduk/mutasi'));
        }
        // End masuk database
    }
