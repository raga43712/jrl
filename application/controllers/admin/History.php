...
class History extends CI_Controller{
	...
	public function __construct(){
		...
		$result = $this->konfigurasi_model->cekMenu($this->session->userdata('akses_level'), 'admin/history'); //base url
		if ($result == false) {
	...
	public function index(){
		...
		$hist = $this->barang_model->hist();
		$brg 	= $this->barang_model->brga();
		//tambah model

		$data = array(
			'title'		=> 'Riwayat Masuk & Keluar Barang',
