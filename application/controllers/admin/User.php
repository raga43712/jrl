...
class User extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$result = $this->konfigurasi_model->cekMenu($this->session->userdata('akses_level'), 'admin/user');
	...
	public function index()
	{
		...
		$grouplist = $this->user_model->menugcm('GRP_USR');
	...
	public function edit($id_user = null)
	{
		...
		$groupMenu = $this->user_model->menugcm('GRP_USR');
		$site 	= $this->konfigurasi_model->listing();
		// Validasi
		$valid = $this->form_validation;
		$valid->set_rules(
