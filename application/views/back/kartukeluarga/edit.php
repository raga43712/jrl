<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            // Form
            echo form_open_multipart('master/KartuKeluarga/edit/' . $user->CD_RESIDENT);
            ?>
            <!-- sekarang masuk ke kolom isi konten -->
            <div class="card mb-4">
                <div class="card-header">
                    <a href="<?php echo site_url('master/KartuKeluarga') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label>Nama Lengkap </label>
                            <input required type="text" name="fullname" readonly class="form-control" placeholder="fullname" value="<?php echo $user->FULL_NAME ?>">
                        </div>
                        <div class="form-group col-md-4">
                            <label>No KTP</label>
                            <input required type="text" name="ktp" readonly class="form-control" placeholder="No KTP" value="<?php echo $user->NO_KTP ?>">
                        </div>
                        <div class="form-group col-md-4">
                            <label>No KK</label>
                            <input required type="text" name="kk" class="form-control" placeholder="No KK" value="<?php echo $user->NO_KK ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input required type="date" name="datebirth" readonly class="form-control" placeholder="Tanggal Lahir" value="<?php echo $user->DATE_BIRTH ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label>Tempat Lahir</label>
                            <input required type="text" name="placebirth" readonly class="form-control" placeholder="Tempat lahir" value="<?php echo $user->PLACE_BIRTH ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Agama</label>
                            <select name="religi" class="form-control" readonly>
                                <option value="">--Pilih--</option>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="edu" class="form-control" readonly>
                                <option value="">--Pilih--</option>
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea class="form-control" name="alamat" readonly id="alamat" rows="3"><?php echo $user->ALAMAT; ?></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="namafather" class="form-control" placeholder="Nama Ayah" value="<?php echo $user->FATHER_NAME ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label>Nama Ibu</label>
                            <input type="text" name="namemother" class="form-control" placeholder="Nama Ibu" value="<?php echo $user->MOTHER_NAME ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>status</label>
                        <select name="nikah" class="form-control" readonly>
                            <option value="">--Pilih--</option>
