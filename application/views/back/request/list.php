            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- <p><a href="<?php echo site_url('penduduk/pendatang/tambah') ?>" class="btn btn-success" data-toggle="modal" data-target="#tambahuser">
                            <i class="fa fa-plus"></i> Request Berkas</a></p> -->
                    <div align='right'>
                        <button type="button" id="submitall" name="submitall" class="btn btn-info btn_proses" 
                        data-toggle="tooltip" data-placement="top" title="Submit All"><i class="fas fa-circle-notch"></i> Proses</button>
                        <a href="<?php echo site_url('penduduk/pendatang/tambah') ?>" class="btn btn-success" 
                ...
                <div class="table-responsive">
                    ...
                    <!-- masuk ke tabel -->
                    <table class="table table-striped table-bordered table-hover" id="example1" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                            ...
                            foreach ($userb as $user) { ?>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="<?php echo site_url('file/request/edit/' . $user->REQUEST_ID) ?>" class="btn btn-secondary btn-sm mr-1"><i class="fa fa-edit"></i> Ubah</a>
