			...
			<div class="card mb-4">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input class="form-control" required type="text" readonly name="name" value="<?php echo $struktur->name ?>" />
					</div>
					...
					<div class="form-group">
						...
						<select name="description" class="form-control">
							...
							<?php foreach ($jabatan as $jabatan) { ?>
								...
								<option value="<?php if ($jabatan->CODE == $struktur->description) {
													echo $jabatan->CODE;
												} else {
													echo $jabatan->CODE;
												}; ?>">
									<?php echo $jabatan->DESCRIPTION; ?> </option>
							<?php
							} ?>
						</select>
