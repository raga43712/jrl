    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p><a href="<?php echo site_url('penduduk/mutasi/tambah') ?>" class="btn btn-success" data-toggle="modal" data-target="#tambahuser">
                            <i class="fa fa-plus"></i> Tambah Pindah</a></p>
                            ...
                            <tbody>
                                ...
                                foreach ($userb as $user) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo date_format(new DateTime($user->DATE_MUTATION), "d F Y") ?></td>
                                        <td><?php echo $user->REASON_MUTATION ?></td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            ...
                                            <a onclick="deleteConfirm('<?php echo site_url('penduduk/mutasi/delete/' . $user->CD_RESIDENT) ?>')" href="#!" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
            ...
            <div class="modal fade" id="tambahuser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo site_url('penduduk/mutasi/tambah') ?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body" style="background-color: floralwhite;">
                                ...
                                <div class="card card-default">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Alasan pindah</label>
