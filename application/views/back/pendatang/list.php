    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p><a href="<?php echo site_url('penduduk/pendatang/tambah') ?>" class="btn btn-success" data-toggle="modal" data-target="#tambahuser">
                            <i class="fa fa-plus"></i> Tambah Pendatang</a></p>
                            ...
                            <tbody>
                                ...
                                foreach ($userb as $user) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo date_format(new DateTime($user->DATE_JOIN), "d F Y") ?></td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="<?php echo site_url('penduduk/pendatang/edit/' . $user->CD_RESIDENT) ?>" class="btn btn-secondary btn-sm mr-1"><i class="fa fa-edit"></i> Ubah</a>
                                            <?php $hey = $user->id_user; ?>
                                            <a onclick="deleteConfirm('<?php echo site_url('penduduk/pendatang/delete/' . $user->CD_RESIDENT) ?>')" href="#!" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
            ...
            <div class="modal fade" id="tambahuser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo site_url('penduduk/pendatang/tambah') ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <di class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required type="date" name="datejoin" class="form-control" placeholder="Tanggal Join" value="<?php echo set_value('datejoin') ?>">
                                            </div>
                                        </di>
