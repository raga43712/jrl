<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            // Form
            echo form_open_multipart('penduduk/pendatang/edit/' . $user->CD_RESIDENT);
            ?>
            <!-- sekarang masuk ke kolom isi konten -->
            <div class="card mb-4">
                <div class="card-header">
                    <a href="<?php echo site_url('penduduk/pendatang') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="nikah" class="form-control">
                                ...
                                <?php foreach ($nikahlist as $nikahlist) {
                                    if (trim($nikahlist->CODE) === trim($user->STATUS)) { ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required type="date" name="datejoin" class="form-control" placeholder="Tanggal Join" value="<?php echo $user->DATE_JOIN; ?>">
                        </div>
                    </div>
