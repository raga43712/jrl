            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" readonly name="nama" class="form-control" placeholder="Nama lengkap" value="<?php echo $user->nama ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <!-- <select name="akses_level" class="form-control">
                            <option value="superadmin" <?php if ($user->akses_level == "superadmin") {
                                                            echo "selected";
                                                        } ?>>Admin PKK</option>
                            <option value="sekret_pokja" <?php if ($user->akses_level == "sekret_pokja") {
                                                                echo "selected";
                                                            } ?>>Sekretaris Pokja</option>
                            <option value="kades" <?php if ($user->akses_level == "kades") {
                                                        echo "selected";
                                                    } ?>>Kepala Desa</option>
                        </select> -->
                        <select name="akses_level" class="form-control">
                            ...
                            <?php foreach ($grpmenu as $grpmenu) {
                                if (trim($grpmenu->CODE) === trim($user->akses_level)) { ?>
                                    <option value="<?php echo $user->akses_level; ?>" selected>
                                        <?php echo $grpmenu->DESCRIPTION; ?> </option>
                                <?php } else { ?>
                                    <option value="<?php echo $grpmenu->CODE; ?>">
                                        <?php echo $grpmenu->DESCRIPTION; ?> </option>
                            <?php }
                            } ?>
                        </select>
